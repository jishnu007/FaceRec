...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        pnet, rnet, onet = detect_face.create_mtcnn(sess, '/home/jishnu/real-time-deep-face-recognition')
        ...
        #train human name
        HumanNames = os.listdir("./media/train_img")
        HumanNames.sort()   
        ...
        video_capture = cv2.VideoCapture('./media/abc.mp4')
        c = 0
